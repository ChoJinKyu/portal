using cm.Org_Tenant from '../../../../db/cds/cm/CM_ORG_TENANT-model';
using cm.Org_Company from '../../../../db/cds/cm/CM_ORG_COMPANY-model';
using cm.Org_Purchasing from '../../../../db/cds/cm/CM_ORG_PURCHASING-model';
using cm.Org_Plant from '../../../../db/cds/cm/CM_ORG_PLANT-model';
using cm.Org_Division from '../../../../db/cds/cm/CM_ORG_DIVISION-model';
using cm.Org_Unit from '../../../../db/cds/cm/CM_ORG_UNIT-model';

namespace cm;

@path : '/cm.OrgMgtService'
