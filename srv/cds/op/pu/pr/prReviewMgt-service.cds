...
service PrReviewMgtService {
    ...
    view Pr_ReviewListView as
        select 
            ...
            // 요청자 관련해서는 품목별로 조회를 하기때문에 Dtl에서 가져와야 한다.
            //,mst.requestor_empno  // 요청자사번
            //,mst.requestor_name  // 요청자명
            ,mst.requestor_department_code  // 요청자부서코드 - Dtl의 요청자 부서를 가져와야하나?? 우선 사용하자.
            ,mst.requestor_department_name  // 요청자부서명 - Dtl의 요청자 부서를 가져와야하나?? 우선 사용하자.
