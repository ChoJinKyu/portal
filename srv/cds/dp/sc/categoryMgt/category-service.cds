using {dp as partCategory} from '../../../../../db/cds/dp/sc/DP_SC_PART_CATEGORY-model';
using {dp as categoryClass} from '../../../../../db/cds/dp/sc/DP_SC_PART_CATEGORY_CLASS-model';
using {dp as categoryAuth} from '../../../../../db/cds/dp/sc/DP_SC_PART_CATEGORY_AUTH-model';
using {dp as categoryList} from '../../../../../db/cds/dp/sc/DP_SC_PART_CATEGORY_LIST_VIEW-model';
