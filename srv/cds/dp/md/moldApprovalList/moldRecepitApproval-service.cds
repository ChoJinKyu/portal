...
service MoldRecepitApprovalService { 
    ...
    view MoldRecepit as
        ...
        join supplier s1 on s1.supplier_code = mst.supplier_code  and s1.tenant_id = mst.tenant_id 
        join supplier s2 on s2.supplier_code = mst.production_supplier_code and s2.tenant_id = mst.tenant_id  
        join cmDept.Hr_Department dep on dep.department_id =  mst.acq_department_code and dep.tenant_id = mst.tenant_id  
