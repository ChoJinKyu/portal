 ...
 *
 */
public class RestPostCallTypeInvoker implements ICallTypeInvoker {

    public Map<String, Object> executeCallType(BizRuleInfo info, Map<String, Object> inData){
        Map<String, Object> outData = new OKHttpRestAPI().doPost(info.getCallHost() + "/" + info.getCallInfo(), inData);
        return outData;
    }
