...
public class SupEvalSetupV4Service implements EventHandler {
    ...
    *********************************/
    ...
    public void onSaveEvaluationSetup1Proc(SaveEvaluationSetup1ProcContext context) {   
    ...
    public void onSaveEvaluationSetup2Proc(SaveEvaluationSetup2ProcContext context) {
        ...
        v_sql_callProc.append("CALL SP_SE_EVAL_SETUP_SAVE1_PROC(");        
            v_sql_callProc.append("I_OPMST => #LOCAL_TEMP_EVALUITEM,");        
