...
public class TaskMonitoringV4 implements EventHandler {
    ...
    public void onUpsertTaskMonitoringMasterProc(UpsertTaskMonitoringMasterProcContext context) {
        ...
        // create temp table: local_temp_tenant
        StringBuffer v_sql_createTable_tenant = new StringBuffer();
		v_sql_createTable_tenant.append("create local temporary column table #local_temp_tenant ( ");
		v_sql_createTable_tenant.append("tenant_id nvarchar(5) ");
		v_sql_createTable_tenant.append(")");        
...
/*********************************************************************************************************************/
		// insert temp table: tenant 
        StringBuffer v_sql_insertTable_tenant = new StringBuffer();
		v_sql_insertTable_tenant .append("insert into #local_temp_tenant values ");
		v_sql_insertTable_tenant.append("(?)");
...
/*********************************************************************************************************************/
		...
		try {
            ...
            // create local temp table: tenant
            PreparedStatement v_stat_table_tenant = conn.prepareStatement(v_sql_createTable_tenant.toString());
            v_stat_table_tenant.execute();

            System.out.println("v_stat_table_tenant");
            System.out.println(v_stat_table_tenant);

            // insert local temp table: tenant
            PreparedStatement v_stat_insert_tenant = conn.prepareStatement(v_sql_insertTable_tenant.toString());

            System.out.println("v_stat_insert_tenant");
            System.out.println(v_stat_insert_tenant);

            UpsertInputType v_inputdetails = context.getInputData();

            System.out.println("v_inputdetails");
            System.out.println(v_inputdetails);

            if(!v_inputdetails.isEmpty() && v_inputdetails.size() > 0){
                // Null 인경우 SQL에 Null이 들어가도록 Object로 get/set 한다.
                v_stat_insert_tenant.setObject(1,	v_inputdetails.getTenantId());
                v_stat_insert_tenant.addBatch();
                v_stat_insert_tenant.executeBatch();
            }
            ...
            System.out.println("v_stat_table_master");
            System.out.println(v_stat_table_master);
            ...
            System.out.println("v_stat_insert_master");
            System.out.println(v_stat_insert_master);
            ...
            System.out.println("v_stat_table_scenario");
            System.out.println(v_stat_table_scenario);
            ...
            System.out.println("v_stat_insert_scenario");
            System.out.println(v_stat_insert_scenario);
            ...
            System.out.println("v_stat_table_company");
            System.out.println(v_stat_table_company);
            ...
            System.out.println("v_stat_insert_company");
            System.out.println(v_stat_insert_company);
            ...
            System.out.println("v_stat_table_bizunit");
            System.out.println(v_stat_table_bizunit);
            ...
            System.out.println("v_stat_insert_bizunit");
            System.out.println(v_stat_insert_bizunit);
            ...
            System.out.println("v_stat_table_purchasingtype");
            System.out.println(v_stat_table_purchasingtype);
            ...
            System.out.println("v_stat_insert_purchasingtype");
            System.out.println(v_stat_insert_purchasingtype);
            ...
            v_stat_table_typecode.execute();

            System.out.println("v_stat_table_typecode");
            System.out.println(v_stat_table_typecode);
            ...
            System.out.println("v_stat_insert_typecode");
            System.out.println(v_stat_insert_typecode);
            ...
            if(!v_inTypeCode.isEmpty() && v_inTypeCode.size() > 0){
                for(TaskMonitoringTypeCode v_inRow : v_inTypeCode){
                    ...
                    v_stat_insert_typecode.setObject(3,		v_inRow.get("monitoring_type_code"));
					v_stat_insert_typecode.setObject(4,		v_inRow.get("language_code"));
					v_stat_insert_typecode.setObject(5,		v_inRow.get("monitoring_type_name"));
					v_stat_insert_typecode.setObject(6,		v_inRow.get("local_create_dtm"));
					v_stat_insert_typecode.setObject(7,		v_inRow.get("local_update_dtm"));
					v_stat_insert_typecode.setObject(8,		v_inRow.get("create_user_id"));
					v_stat_insert_typecode.setObject(9,		v_inRow.get("update_user_id"));
					v_stat_insert_typecode.setObject(10,	v_inRow.get("system_create_dtm"));
					v_stat_insert_typecode.setObject(11,	v_inRow.get("system_update_dtm"));
            ...
            System.out.println("v_stat_table_manager");
            System.out.println(v_stat_table_manager);
            ...
            System.out.println("v_stat_insert_manager");
            System.out.println(v_stat_insert_manager);
            ...
            System.out.println("v_stat_table_operation");
            System.out.println(v_stat_table_operation);
            ...
            System.out.println("v_stat_insert_operation");
            System.out.println(v_stat_insert_operation);
            ...
            System.out.println("v_statement_proc");
            System.out.println(v_statement_proc);
