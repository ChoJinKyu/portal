...
public class BasePriceArlValidationV4 {
     ...
     */
    public void validationBasePriceArlMaster(EventContext context, Collection<BasePriceArlMstType> basePriceArlMasters, boolean isDebug) {
     ...
     */
    public void validationBasePriceArlApprover(EventContext context, Collection<BasePriceArlApproverType> basePriceArlApprovers, boolean isDebug) {
     ...
     */
    public void validationBasePriceArlReferer(EventContext context, Collection<BasePriceArlRefererType> basePriceArlReferers, boolean isDebug) {
     ...
     */
    public void validationBasePriceArlDetail(EventContext context, Collection<BasePriceArlDtlType> basePriceArlDetails, boolean isDebug) {
     ...
     */
    public void validationBasePriceArlPrice(EventContext context, Collection<BasePriceArlPriceType> basePriceArlPrices, boolean isDebug) {
