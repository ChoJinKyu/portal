...
public class SupplierIdeaMgtV4 implements EventHandler {
    ...
    public void CreateIdeaStatusProc(CreateIdeaStatusProcContext context) {
        ...
        v_sql_createTable.append("CREATE local TEMPORARY column TABLE #LOCAL_TEMP_SI (");        
        ...
        String v_sql_insertTable = "INSERT INTO #LOCAL_TEMP_SI VALUES (?, ?, ?, ?, ?,    ?, ?, ?, ?, ?,   ?, ?, current_date, ?, ?)";
        String v_sql_callProc = "CALL DP_PD_PRODUCT_ACTIVITY_SAVE_PROC(I_TABLE => #LOCAL_TEMP_SI, O_MSG => ?)";
        
        String v_sql_dropable = "DROP TABLE #LOCAL_TEMP_SI";
