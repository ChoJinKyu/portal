...
using { op.Pu_Pr_Template_DtlView as tpldv } from './OP_PU_PR_TEMPLATE_DTLVIEW-model';
...
entity Pu_Pr_Template_Mst {	 
    ...
    tpldvs : Composition of many tpldv
            on tpldvs.tenant_id = tenant_id
               and tpldvs.pr_template_number = pr_template_number ;
