...
entity Approver {
    ...
    key approver_empno        : String(30) not null @title : '결재자사번';
        ...
        approver_type_code_fk : Association to code
                                    on  approver_type_code_fk.tenant_id  = tenant_id
                                    and approver_type_code_fk.group_code = 'CM_APPROVER_TYPE'
                                    and approver_type_code_fk.code       = approver_type_code;
}
