...
entity Vp_Supplier_Mst_View {
    ...
    supplier_type_code: String(30) @title: '공급업체상태코드';
    supplier_type_name: String(240) @title: '공급업체상태명';
    inactive_status_code: String(30) @title: '공급업체유형코드(VP운영단위코드)';
    inactive_status_name: String(240) @title: '공급업체유형명';
