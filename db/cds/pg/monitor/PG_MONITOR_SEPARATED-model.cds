/************************************************
  ...
  5. namespace : pg
  6. entity : Monitor_Separated
  7. entity description : 모니터링 구분
  8. history
...
using {pg as Monitoring_Separated} from '../monitor/PG_MONITOR_SEPARATED-model';

entity Monitor_Separated {
...
extend Monitor_Separated with util.Managed;
