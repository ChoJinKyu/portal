/************************************************
  ...
  5. namespace : pg
  6. entity : Monitor_Scenario
  7. entity description : 모니터링 시나리오
  8. history
...
using {pg as Monitoring_Senario} from '../monitor/PG_MONITOR_SCENARIO-model';

entity Monitor_Scenario {
...
extend Monitor_Scenario with util.Managed;
