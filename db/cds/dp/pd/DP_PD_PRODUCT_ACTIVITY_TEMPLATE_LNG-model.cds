...
using {dp as DpProductActivityTemplate} from '../pd/DP_PD_PRODUCT_ACTIVITY_TEMPLATE-model';	
...
entity Pd_Product_Activity_Template_Lng {	
  ...
  key product_activity_code : String(40)  not null @title: '제품Activity코드' ;
         ...
         parent      : Association to DpProductActivityTemplate.Pd_Product_Activity_Template
                          on  parent.tenant_id  = tenant_id
                          and parent.product_activity_code = product_activity_code;
