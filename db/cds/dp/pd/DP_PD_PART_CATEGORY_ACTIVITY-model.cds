...
entity Pd_Part_Category_Activity {	
  ...
  key activity_code : String(40)  not null @title: 'Activity코드' ;	
    s_grade_standard_days : Decimal default 0  @title: 'S' ;	
    a_grade_standard_days : Decimal default 0  @title: 'A' ;	
    b_grade_standard_days : Decimal default 0  @title: 'B' ;	
    c_grade_standard_days : Decimal default 0  @title: 'C' ;	
    d_grade_standard_days : Decimal default 0  @title: 'D' ;	
