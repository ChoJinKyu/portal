...
entity Np_Net_Price_Mst_View {	
  ...
  key material_code : String(40)  not null @title: '자재코드' ;	
      material_desc : String(300)  @title: '자재명' ;	
  key market_code : String(30)  not null @title: '납선코드' ;	
      market_name : String(240)  @title: '납선명' ;	
  key effective_start_date : String(8)  not null @title: '유효시작일자' ;	
    ...
    payterms_name : String(240)  @title: '지불조건명' ;	
    incoterms : String(3)   @title: '인코텀즈' ;	
    incoterms_name : String(240)  @title: '인코텀즈명' ;	
    buyer_empno : String(30)   @title: '구매담당자사번' ;	
    buyer_name : String(240)  @title: '구매담당자명' ;	
    ...
    maker_name : String(240)  @title: '제조사명' ;	
    ...
    customs_rate : Decimal(34,5)   @title: '관세율' ;	
    origin_code : String(30)   @title: '원산지코드' ;	
    origin_name : String(240)   @title: '원산지명' ;	
    ...
    create_user_id : String(255)   @title: '생성자' ;	
	  ...
	  system_create_dtm : DateTime   @title: '생성일시' ;	
	  system_update_dtm : DateTime   @title: '수정일시' ;	
}	