...
entity Sup_Supplier_Mst {	
  ...
  key supplier_code : String(10)  not null;	
    supplier_local_name : String(100)  ;	
    supplier_engligh_name : String(100)  ;	
    tax_id : String(16)  ;	
    ...
    inactive_status_code : String(20)  ;	
    ...
    family_tree_code : String(20)  ;	
    family_tree_name : String(50)  ;	
    credit_evaluation_interface_code : String(20)  ;	
}
