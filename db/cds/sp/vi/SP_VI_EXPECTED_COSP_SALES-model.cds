 ...
 * 5. namespace : sp
 *
 * 6. entity : Vi_Expected_Cosp_Sales
 *
 * 7. entity description : C-OSP 예상실적
 *
...
// using {sp as viExpCospSale} from '../sp/SP_VI_EXPECTED_COSP_SALES-model';

entity Vi_Expected_Cosp_Sales {
...
annotate Vi_Expected_Cosp_Sales with @title : 'C-OSP예상실적'  @description : 'C-OSP 단품에 대한 예상 판매실적';
