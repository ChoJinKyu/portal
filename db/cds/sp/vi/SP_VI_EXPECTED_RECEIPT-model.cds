 ...
 * 5. namespace : sp
 *
 * 6. entity : Vi_Expected_Receipt
 *
 * 7. entity description : 예상입고수량
 *
...
// using {sp as viExpReceipt} from '../sp/SP_VI_EXPECTED_RECEIPT-model';
...
annotate Vi_Expected_Receipt with @title : '예상입고수량'  @description : '예상입고수량';
