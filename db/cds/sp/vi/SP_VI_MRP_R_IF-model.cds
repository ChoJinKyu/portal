...
entity Vi_Mrp_R_If {
    ...
    flxfld1_inventory_qty         : Decimal;
    flxfld1_receiving_exp_qty     : Decimal;
    flxfld1_gross_req_qty         : Decimal;
    ...
    flxfld10_gross_req_qty        : Decimal;
    ...
    flxfld11_gross_req_qty        : Decimal;
    ...
    flxfld12_gross_req_qty        : Decimal;
