...
entity Vi_Base_Price_Aprl_Metal {	
...
extend Vi_Base_Price_Aprl_Metal with util.Managed;

annotate Vi_Base_Price_Aprl_Metal with @title : '양산가 품의 메탈상세'  @description : '양산가 품의 메탈상세';

annotate Vi_Base_Price_Aprl_Metal with {
