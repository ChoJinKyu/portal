...
entity Se_Eval_Sheet_Vp_Manager {	
  ...
  key vendor_pool_code_person_empno  : String(30)  not null @title: '협력사풀코드담당자사번' ;	
}	
extend Se_Eval_Sheet_Vp_Manager with util.Managed;	
