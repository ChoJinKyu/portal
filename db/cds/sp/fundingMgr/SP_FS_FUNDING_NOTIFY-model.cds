...
entity Fs_Funding_Notify {
    ...
    key funding_notify_number     : String(8)   not null    @title : '자금지원공고번호';
        ...
        funding_notify_start_date : String(8)   not null    @title : '자금지원공고시작일자';
        funding_notify_end_date   : String(8)   not null    @title : '자금지원공고종료일자';
        funding_appl_closing_date : String(8)               @title : '자금지원신청마감일자';
