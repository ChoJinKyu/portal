sap.ui.define([
	...
	return BaseController.extend("op.pu.PrMgt.controller.MainList", {
        ...
        onInitPR_TYPE3: function () {            
            var oPR_TYPE3 = this.byId("SelectionPR_TYPE3");
            var vPR_TYPE2Value = this.byId("SelectionPR_TYPE2").getSelectedKey();
            var aFilters = [
                    new Filter("tenant_id", FilterOperator.EQ, "L2100"),
                    new Filter("group_code", FilterOperator.EQ, 'OP_PR_TYPE_CODE_3'),
                    new Filter("parent_code", FilterOperator.EQ, vPR_TYPE2Value)
                ];
            ...
            oPR_TYPE3.bindItems("util>/CodeDetails", oItemTemplate, null, aFilters);

        },

        onInitPR_TYPE: function () {            
            var oPR_TYPE = this.byId("SelectionPR_TYPE");
            var vPR_TYPE3Value = this.byId("SelectionPR_TYPE3").getSelectedKey();
            var aFilters = [
                    new Filter("tenant_id", FilterOperator.EQ, "L2100"),
                    new Filter("group_code", FilterOperator.EQ, 'OP_PR_TYPE_CODE'),
                    new Filter("parent_code", FilterOperator.EQ, vPR_TYPE3Value)
                ];
            var oItemTemplate = new sap.ui.core.ListItem({
                key : "{util>code}",
                text : "{util>code}: {util>code_description}",
            ...
            oPR_TYPE.bindItems("util>/CodeDetails", oItemTemplate, null, aFilters);

        },


        onInitTemplate: function () {            
            var oSegmentButton = this.byId("searchUsageSegmentButton");
            var vPR_TYPEValue = this.byId("SelectionPR_TYPE").getSelectedKey();
            var aFilters = [
                    new Filter("tenant_id", FilterOperator.EQ, "L2100"),
                    new Filter("group_code", FilterOperator.EQ, 'OP_PR_TYPE_CODE'),
                    new Filter("parent_code", FilterOperator.EQ, vPR_TYPE3Value)
            ...
            var oItemTemplate = new sap.ui.core.ListItem({
             ...
             oSegmentButton.bindItems("util>/CodeDetails", oItemTemplate, null, aFilters);
