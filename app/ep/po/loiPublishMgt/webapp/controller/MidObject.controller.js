sap.ui.define([
	...
	return BaseController.extend("ep.po.loiPublishMgt.controller.MidObject", {
		...
		_onRoutedThisPage: function(oEvent){
            ...
            //    var loiSSModel = this.getModel("loiSupplySelection");
            //    var sObjectPath = "/LoiDtl(tenant_id='1000', company_code='C100, loi_selection_number='121000000002', loi_item_number='itemcode2')";
			// 	loiSSModel.read(sObjectPath, {
			// 		success: function(oData){
			// 			oView.setBusy(false);
			// 		}
			// 	});               
            ...
            // oModel2.read("/LoiDtl(tenant_id='1000', company_code='C100, loi_selection_number='121000000002', loi_item_number='itemcode2')", null, null, false, function (oData) {
            //     oODataJSONModelDLSet.setData(oData);
            // });

            // console.log("oODataJSONModelDLSet====", oODataJSONModelDLSet.getData());
                ...
                //뷰생성해서 변경예정
                var sObjectPath = "/LoiVendorSelection(tenant_id='" + this._sTenantId + "',company_code='" + this._sCompanyCode + "',loi_selection_number='" + this._sLoiSelectionNumber + "')";
                var oMasterModel = this.getModel("master");
				oView.setBusy(true);
