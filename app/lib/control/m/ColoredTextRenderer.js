sap.ui.define([
    ...
    var ColoredTextRenderer = jQuery.extend(true, {}, TextRenderer);

    ColoredTextRenderer.render = function(oRm, oText) {
        // get control values
    ...
    // ColoredTextRenderer.renderText = function(oRm, oText) {
