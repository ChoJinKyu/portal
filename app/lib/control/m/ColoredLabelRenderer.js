sap.ui.define([
    ...
    "jquery.sap.global",
], function (LabelRenderer, Core, Renderer, library, coreLibrary, HyphenationSupport, LabelEnablement, jQuery) {
    "use strict";
    ...
    var ColoredLabelRenderer = jQuery.extend(true, {}, LabelRenderer);
	 ...
	 */
	ColoredLabelRenderer.render = function(rm, oLabel){
		// convenience variable
		var r = ColoredLabelRenderer,
			sTextDir = oLabel.getTextDirection(),
			sTextAlign = oLabel.getTextAlign(),
            sWidth = oLabel.getWidth(),
            sColor = oLabel.getColor(),
	 ...
	 * @private
	 */
	ColoredLabelRenderer.getTextAlign = Renderer.getTextAlign;
