sap.ui.define([
  ...
  function (BaseController, JSONModel, ManagedListModel, DateFormatter, Filter, FilterOperator, MessageBox) {
    ...
    return BaseController.extend("dp.tc.projectMgt.controller.McstProjectMgtDetail", {
        ...
        onInit: function () {
            ...
            //this.oRouter.getRoute("McstProjectMgtDetail").attachPatternMatched(this._getProjectDetail, this);
            this.oRouter.getRoute("McstProjectMgtDetail").attachPatternMatched(this._reNumberProcModel, this);
        ...
        , _reNumberProcModel: function() {
            var oModel = this.getModel("v4ProcMcst");
            ...
            var popupListModel = this.getModel("popupListModel").getData().results;
            debugger;

            var oSendData = {
                    inputData : {
                        tenant_id  : "L2100",
                        project_code : "PA-123456",
                        model_code : "M-CD1",
                        mcst_code  : "QUOTATION",
                        user_id    : "A53924"
                    }
            ...
            $.ajax({
                ...
                success: function(data){
                    console.log("_reNumberProcModel호출.", {at: "Center Center"});
        ...
        , _reFactorySaveModel: function() {
            var oDetailModel = this.getModel("popupListModel");
