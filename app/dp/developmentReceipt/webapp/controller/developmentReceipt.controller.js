		...
		_getSearchStates: function(){
			...
			if (receiptDate && receiptDate.length > 0) {
                aTableSearchState.push(new Filter({
					filters: [
						new Filter("receiving_report_date", FilterOperator.GEipreceiptDate.getDateValue()						new Filter("receiving_report_date", FilterOperator.LEipreceiptDate.getSecondDateValue())
					],
					and: false
				}));
