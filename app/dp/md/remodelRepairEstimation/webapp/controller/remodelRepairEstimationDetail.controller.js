sap.ui.define([
	...
	return BaseController.extend("dp.md.remodelRepairEstimationDetail.controller.remodelRepairEstimationDetail", {
		...
		_onRoutedThisPage: function(oEvent){
            ...
            console.log('_onRoutedThisPage start');
            ...
            console.log(this._sTenantId, this._sMoldId);
			...
			// 		name: "dp.md.detailSpecConfirm.view.remodelRepairEstimationDetail",
			// 		controller: this
            ...
            console.log('_onRoutedThisPage end');
        },
