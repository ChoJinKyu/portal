sap.ui.define([
    ...
    return ApprovalBaseController.extend("dp.md.moldApprovalList.controller.RemodelRepairCompletionReport", {
        ...
        onInit: function () {
            ...
            this.setModel(oViewModel, "remodelRepairCompletionReportView"); //change
            this.getRouter().getRoute("remodelRepairCompletionReport").attachPatternMatched(this._onObjectMatched, this);//change
            this.process.setDrawProcessUI(this, "RrcReportProcess" , "B", 6); 
        },
