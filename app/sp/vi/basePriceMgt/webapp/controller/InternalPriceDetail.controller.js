        ...
        */
        ...
        , onListRowAdd: function (selected) {
            ...
            aDetails.push({
                        ...
                        supply_plant_code : sSupply_plant_code,
        ...
        , _SendDataModel : function(approval_status_code){ 
            ...
            aPriceData.forEach(function(oPrice, idx) {
                ...
                var oNewPriceObj = {};
                    ...
                    oNewPriceObj['supply_plant_code'] = aPriceData[idx].supply_plant_code;
            ...
            for (var i=0; i<=aPriceResult.length-1; i++){
                ...
                if (!aPriceResult[i].supply_plant_code){
                    MessageBox.show("공급플랜트는 필수입니다. ");
                    return;
                }
