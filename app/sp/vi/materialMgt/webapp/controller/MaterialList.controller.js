sap.ui.define([
  ...
  function (BaseController, JSONModel, DateFormatter, Filter, FilterOperator, Fragment, MessageBox, ExcelUtil, EmployeeDialog, SupplierDialog,
    ...
    return BaseController.extend("sp.vi.materialMgt.controller.MaterialList", {
        ...
        onInit: function () {
            ...
            this.getRouter().getRoute("MaterialList").attachPatternMatched(this.onSearch, this); 
        }
        ...
        , onSearch: function (oEvent) {
            ...
            //this._getMaterialList(aFilters);
        },
        
        /**
         * 예외자재 목록 조회
         */
        _getMaterialList: function(filtersParam) {
