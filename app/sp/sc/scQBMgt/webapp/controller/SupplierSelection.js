sap.ui.define([
    ...
    var SupplierSelection = EventProvider.extend("sp.sc.scQBMgt.SupplierSelection", {
        ...
        showSupplierSelection: function(oThis, oEvent, sCompanyCode, sPlantCode, callback){
            ...
            oSuppValueHelpDialog = sap.ui.xmlfragment("sp.sc.scQBMgt.view.SupplierSelection", oThis);
