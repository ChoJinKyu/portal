sap.ui.define([
    ...
    var SupplierSelection = EventProvider.extend("sp.sc.scQBCreate.SupplierSelection", {
        ...
        showSupplierSelection: function(oThis, oEvent, sCompanyCode, sPlantCode, callback){
            ...
            oSuppValueHelpDialog = sap.ui.xmlfragment("sp.sc.scQBCreate.view.SupplierSelection", oThis);
