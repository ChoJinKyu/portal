sap.ui.define([
     ...
     * @date 2020.12.01
     */
	return BaseController.extend("op.pu.prReviewMgt.controller.MidCreateObject", {
        ...
        _fnCallAjax: function (sendData, targetName , callback) {            
            var that = this;            
            var url = "/op/pu/prReviewMgt/webapp/srv-api/odata/v4/op.PrCreateV4Service/" + targetName;
		...
		onOpenMaterialDialog: function (oEvent) {
           ...
           // oMarterialCodeModel.attachRequestCompleted(function(data) {
                ...
                //         id: oView.getId(),
                //         name: "op.pu.prReviewMgt.view.MaterialDialog",
                //         controller: this
