sap.ui.define([
	...
	return BaseController.extend("pg.mdCategoryItem.controller.mdCategoryItemDetail", {  
		...
		_onRoutedThisPage: function(oEvent){
            ...
            if(oArgs.spmd_character_code == "new" ){
                ...
                // var url = "pg/mdCategoryItem2/webapp/srv-api/odata/v4/pg.MdCategoryV4Service/MdItemListConditionView(language_code='KO')/Set";    // 아이템특성목록View 파라메터 호출O
                // $.ajax({
                //     url: url,
                //     type: "GET",
