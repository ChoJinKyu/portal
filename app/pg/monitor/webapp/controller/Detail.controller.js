...
sap.ui.define([
  ...
  return BaseController.extend("pg.monitor.controller.Detail", {
    onInit: function () {
    ...
    /**
     * signalListItem comboBox condition
     * @public     * 
     */
    onSignalCondition : function(oEvent) {

        console.group("onSignalCondition");
        
       // var oSelectedField = sap.ui.getCore().byId(that._FieldID);
       //oEvent.getSource().getParent().getCells()[1].setEnabled = false;
      // debugger;
        //var sid1 = oEvent.getSource().getParent().getCells()[1].sId;
        //var sid2 = oEvent.getSource().getParent().getCells()[2].sId;

        //$( "#"+sid1).prop( "disabled" );
        //$( "#"+sid2).prop( "disabled" );

        //sap.ui.getCore().byId(sid2).bindProperty("editable",false);
        //debugger;
        //oEvent.getSource().getParent().getCells()[2].mProperties.enabled = true;
        //oEvent.getSource().getParent().getCells()[2].mProperties.editable = true;
        //oEvent.getSource().getCells()[2].mProperties.enabled = true;
        //oEvent.getSource().getCells()[2].mProperties.editable = true;
       // $("#__input0-container-monitor---idAppControl--signalList-0-inner").prop( "disabled", true );

        // oEvent.getSource().getParent().getCells()[1].setEditable(false);
        // oEvent.getSource().getParent().getCells()[1].setEditable(true);
        // oEvent.getSource().getCustomData()[1].getValue();
        //debugger;
        //var oItem = oEvent.getSelectedContexts();
        console.groupEnd();
    },
    ...
    onTest: function() {
        ...
        //     "language_code": "KO",
        //     "indicator_comparison_basic_text": "ppppp",
        //     "local_create_dtm": "2020-11-11T19:52:00Z",
        //     "local_update_dtm": "2020-11-11T19:52:00Z",
        //     "create_user_id": "Admin",
        //     "update_user_id": "Admin",
        //     "system_create_dtm": "2020-11-11T19:52:00Z",
        //     "system_update_dtm": "2020-11-11T19:52:00Z"
        // };
        ...
        var oData = {
            ...
            "indicator_comparison_basic": "%",
            "language_code": "KK",
            "indicator_comparison_basic_text": "KKer",
            "local_create_dtm": "2020-11-11T19:52:00Z",
            "local_update_dtm": "2020-11-11T19:52:00Z",
            "create_user_id": "Admin",
            "update_user_id": "Admin",
        ...
        //     "testfield": "L2100"
        // };
        oModel.create("/IndicatorComparisonBasic", oData, {success: this.mySuccessHandler, error: this.myErrorHandler});         
    }
