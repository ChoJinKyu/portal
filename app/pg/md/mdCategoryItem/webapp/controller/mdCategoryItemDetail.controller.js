					...
					if (sButton === MessageBox.Action.OK) {
                        ...
                        if(that._sSpmd_character_code !== "new"){
                            ...
                            //new ODataXhrService.ajax({ 
                                url: "pg/md/mdCategory/webapp/srv-api/odata/v4/pg.MdCategoryV4Service/MdNewCategoryItemCode(tenant_id='L2100',company_code='*',org_type_code='BU',org_code='BIZ00200')/Set", 
                                type: "GET", 
