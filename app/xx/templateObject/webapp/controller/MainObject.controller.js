sap.ui.define([
  ...
  return BaseController.extend("xx.templateObject.controller.MainObject", {
    ...
    /* =========================================================== */
		 ...
		 * If not, it will replace the current entry of the browser history with the miainList route.n
		 * @public
		 */
    ...
    _loadFragment: function (sFragmentName, oHandler) {
      if (!this._oFragments[sFragmentName]) {
        Fragment.load({
          ...
          name: "xx.templateObject.view." + sFragmentName,
          controller: this
