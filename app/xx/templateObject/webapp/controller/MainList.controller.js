sap.ui.define([
  ...
  "sap/m/ComboBox",
  "sap/ui/core/Item",
], function (BaseController, JSONModel, ManagedListModel, History, formatter, TablePersoController, MainListPersoService, Filter, FilterOperator, MessageBox, MessageToast, ColumnListItem, ObjectIdentifier, Text, Input, ComboBox, Item) {
  "use strict";

  return BaseController.extend("xx.templateObject.controller.MainList", {
