sap.ui.define([
	...
	return BaseController.extend("xx.templateListInlneEdit.controller.MainList", {
		 ...
		 * @public
		 */
        onListMainTableCancelButtonPress: function(){
			this._toShowMode();
        },
        
        onListMainTableConfirmButtonPress: function(){
		...
		_doInitTablePerso: function(){
			...
			this._oTPC = new TablePersoController({
				...
				componentName: "templateListInlneEdit",
