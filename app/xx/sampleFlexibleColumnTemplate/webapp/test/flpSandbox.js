						...
						"inbounds": {
							"Template-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.template.sampleFlexibleColumnTemplate",
									"url": sap.ui.require.toUrl("com/template/sampleFlexibleColumnTemplate")
								}
							}
						}
					}
