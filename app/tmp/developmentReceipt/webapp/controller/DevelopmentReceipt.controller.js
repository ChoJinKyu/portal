sap.ui.define([
    ...
    return BaseController.extend("tmp.developmentReceipt.controller.DevelopmentReceipt", {
        ...
        handleEmployeeSelectDialogPress: function (oEvent) {
            ...
            if (!this._oDialog) {
                this._oDialog = Fragment.load({
                    id: oView.getId(),
                    name: "tmp.developmentReceipt.view.Employee",
                    controller: this
...
/*
        ...
        onValueHelpRequested: function (oEvent) {
            ...
            var path = '';
            this._oValueHelpDialog = sap.ui.xmlfragment("tmp.developmentReceipt.view.ValueHelpDialogModel", this);
