sap.ui.define(["jquery.sap.global"],
    function (jQuery) {
        ...
        var _aColunns = [
            {
                id: "test-mainList-mainColumnState",
                order: 9,
                text: "State",
                visible: false
            },
            {
                id: "test-mainList-mainColumnChainCode",
                order: 1,
                text: "{I18N>/CHAIN}",
                visible: true
            },
            {
                id: "test-mainList-mainColumnLanguageCode",
                order: 2,
                text: "{I18N>/LANGUAGE}",
                visible: true
            },
            {
                id: "test-mainList-mainColumnMessageCode",
                order: 3,
                text: "{I18N>/CODE}",
                visible: true
            },
            {
                id: "test-mainList-mainColumnMessageContents",
                order: 4,
                text: "{I18N>/CONTENTS}",
                visible: true
            },
            {
                id: "test-mainList-mainColumnMessageTypeCode",
                order: 5,
                text: "{I18N>/TYPE}",
                visible: true
            }
