  ...
  function (Controller, Fragment, JSONModel, Filter, FilterOperator, FilterType, MessageToast, MessageBox, DateFormat) {
    ...
    return Controller.extend("cm.timeZoneMgr.controller.timeZoneMgr", {
      ...
      onAfterRendering: function () {
        ...
        // var rows = this.byId("mainTable").getRows();
        // console.log("\t\t>>>>>>>> rows", rows);
        // rows.forEach(function (r) {
        //   console.log(">>>>>>>>>> ", r);
        //   (rows[r].getCells()[1]).setText(r + 1);
        // });
      },
      ...
      handleValueHelp: function () {
        var sInputValue = this.byId("searchCountryInput").getValue();
      ...
      _configValueHelpDialog: function () {
        var sInputValue = this.byId("searchCountryInput").getValue(),
          ...
          aCountry = oModel.setProperty("/searchCountryInput", sInputValue);
        oModel.setProperty("searchCountryInput", sInputValue);
      },
      ...
      handleValueHelpClose: function (oEvent) {
        ...
        this.byId("searchCountryInput").setValue(vInputData);
      },
      ...
      onhandleValueHelpClose: function (oEvent) {
        ...
        this.byId("searchCountryInput").setSelectedKey(sDescription);
      ...
      onSearch: function () {
        var rows = this.byId("mainTable").getBinding("rows");
        rows.resetChanges()
