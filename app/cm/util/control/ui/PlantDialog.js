sap.ui.define([
    ...
    var PlantDialog = Parent.extend("cm.util.control.ui.PlantDialog", {
        ...
        createSearchFilters: function(){
            return [
                new VBox({
                    items: [
                        new Label({ text: this.getModel("I18N").getText("/PLANT_CODE") +" or "+ this.getModel("I18N").getText("/PLANT_NAME")}),
                        this.oSearchKeyword
                    ],
        ...
        createTableColumns: function(){
            //타이틀 다국어 처리
            this.getProperty("title") ? this.getProperty("title") : this.setProperty("title" , this.getModel("I18N").getText("/PLANT"));
            return [
                new Column({
                    width: "30%",
                    hAlign: "Center",
                ...
                new Column({
                    width: "70%",
                    label: new Label({text: this.getModel("I18N").getText("/PLANT_NAME")}),
