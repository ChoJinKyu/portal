sap.ui.define([
  ...
  return BaseController.extend("cm.ctryMgr.controller.MainList", {
    ...
    onMainTableUpdateFinished: function (oEvent) {
      ...
      if (iTotalItems && oTable.getBinding("items").isLengthFinal()) {
        sTitle = this.getOwnerComponent().getModel("i18n").getResourceBundle().getText("mainListTableTitleCount", [iTotalItems]);
      } else {
        sTitle = this.getOwnerComponent().getModel("i18n").getResourceBundle().getText("mainListTableTitle");
      }
    ...
    onMainTableItemPress: function (oEvent) {
      ...
      this.getRouter().navTo("midPage", {
        ...
        country_code: oRecord.country_code,
        language_code: oRecord.language_code
      });
